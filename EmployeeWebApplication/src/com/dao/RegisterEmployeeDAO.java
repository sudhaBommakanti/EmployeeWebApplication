...
public class RegisterEmployeeDAO {
	...
	public static boolean validate(String firstName, String lastName, String salary, String isCEO, String isManager,
			String managerId) {
		...
		try {
			...
			// System.out.println ("Row data: " +firstName + lastName + salary + isCEO +
			// isManager + manId + "from form");
